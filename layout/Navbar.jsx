...
const Navbar = () => {
  ...
  return (
    <header className='fixed right-0 top-0 left-0 bg-[#00000050] w-screen py-4 z-99 backdrop-blur-[6px] overflow-hidden' >
        <nav className='container mx-auto px-6 flex items-center justify-between overflow-hidden'>
