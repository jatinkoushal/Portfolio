...
const Projects = () => {
  ...
  return (
    <div className='bg-[rgb(15,20,24)] h-[160vh]' >
      <div className='flex flex-col items-center p-18 md:p-20 md:ml-50 md:w-[70%] md:pt-20 pt-110' id='projects'>
    ...
    <div className='flex justify-center' >
      <button className='flex w-115 md:w-55 h-15 rounded-full border-none mt-3 items-center justify-center btn-color text-lg font-bold' >
